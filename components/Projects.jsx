...
const Projects = () => {
  return (
    <section className='px-6 mt-0 mb-2'>
      <h2 className='text-[16px] font-normal text-start mb-4 text-gray-700'>Projects</h2>
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-3xl mx-auto'>
        {projects.map((project, index) => (
          <div key={index} className='group bg-gray-900/20 backdrop-blur-md rounded-lg p-3 border border-gray-800/30 hover:border-cyan-400/50 transition-all duration-300 hover:scale-[1.01]'>
            ...
            <p className='text-gray-400 mb-2 text-xs leading-tight'>{project.description}</p>
            ...
            <div className='flex gap-1 pt-0.5'>
              <a href={project.live} className='flex items-center gap-1 px-2 py-1 bg-linear-to-r from-cyan-500/80 to-blue-500/80 text-white text-[10px] rounded hover:from-cyan-400 hover:to-blue-400 transition-all duration-200 font-medium flex-1 justify-center'>
                Live
              </a>
