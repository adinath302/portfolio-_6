...
const TechStack = () => {
  return (
    <section className='px-6 mt-10.5 mb-0 min-h-50'>
      <h2 className='text-[16px] font-bold mb-8 text-gray-700 q1 text-start'>Tech Stack</h2>
        ...
        {techStack.map((tech, index) => {
          ...
          return (
            ...
            >
              ...
              <span className={`text-xs font-mono font-light ${tech.textColor} tracking-tight text-center leading-tight px-1`}>
                {tech.name}
              </span>
            </div>
          );
